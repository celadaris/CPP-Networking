...
{
public:
	ServerCode(boost::signals2::signal<void()>* bufferEvent, boost::asio::io_context& io_context, std::mutex* m, std::queue<boost::array<unsigned char, 1>>* bufferQueue)
		: socket(io_context, udp::endpoint(udp::v4(), 23000))
	{
